...
class attack_msf():
    ...
    def load_mesh(self, path, r, x_of=40, y_of=5):
        z_of = -1.73 + r / 2.
        # z_of = -15 + r / 2.
        global xof
        global yof
    ...
    def parse_yolo_region(self, outputs, fname):
        # ===========================
        global xof
        global yof
        global rof
        ...
        import csv
        with open('./fuzzing/result/'+str(fname)+'.csv','a', newline='') as csvfile:
            csvWriter = csv.writer(csvfile)
            csvWriter.writerow(["----"])
            csvWriter.writerow([len(objects)])
            csvWriter.writerow([args.x, args.y, args.r, args.object, args.cam])
            for i in range(len(objects)):
                item = objects[i]
    ...
    def rendering_img(self, ppath):
        ...
        self.parse_yolo_region(outputs, "output1")
        ...
        for it in range(iteration):
            ...
            if it < iteration - 1:
                ...
                del grid
                del point_cloud
        self.parse_yolo_region(outputs, "output2")
