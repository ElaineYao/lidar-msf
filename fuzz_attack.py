...
if __name__ == '__main__':
    ...
    # parser.add_argument('-it', '--iteration', dest='iteration', type=int, default=1000)
    parser.parse_args('-x', '--x', dest='x',default=7)
    parser.parse_args('-y', '--y', dest='y',default=0)
    parser.parse_args('-r', '--r', dest='r',default=0.15)
    ...
    obj.load_mesh(args.object, args.r, args.x, args.y)
